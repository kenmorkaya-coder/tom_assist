...
1. Find a second real same-project claim family whose sources genuinely
   disagree. An explicit revision-history statement is a supported historical
   change, not an authority conflict.
